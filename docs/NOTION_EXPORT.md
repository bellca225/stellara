...
핵심 화면 흐름과 Prokerala 연동 골격은 존재하지만 Firebase, Cloud Functions, AI, 공유 기능은 순차적으로 붙여가는 중이다.
...
- Firebase / Functions 전환 전까지는 현재 Flutter 골격을 최대한 유지한다
...
- 이 방식은 임시 운영이며, 장기적으로는 Cloud Functions 프록시로 이전하는 것이 목표
...
3. Cloud Functions 스캐폴드
4. places-resolve 구현
5. 출생정보 Firestore 저장
6. 나탈 / 운세 경로를 Functions 로 전환
7. 친구 / 즐겨찾기 / 궁합 연결
8. AI 질문 연결
9. 공유 / 디자인 선행 준비
10. 공유 / 디자인 마감
