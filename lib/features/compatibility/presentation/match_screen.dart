...
// Icon__17_.svg — 하트 (stroke #51A2FF, 40×40)
...
// Icon__18_.svg — 뒤로가기 (stroke #8EC5FF, 20×20)
...
// Icon__19_.svg — 헤더 공유 (stroke #8EC5FF, 20×20)
...
// Icon__20_.svg — SNS 공유 버튼 (stroke white, 20×20)
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _AnalysisCard(
          label: '감정',
          percent: r.emotionScore,
          description: r.emotionalMatch,
        ),
        const SizedBox(height: 12),
        _AnalysisCard(
          label: '대화',
          percent: r.communicationScore,
          description: r.communicationStyle,
        ),
        const SizedBox(height: 12),
        _AnalysisCard(
          label: '연애 스타일',
          percent: r.romanceScore,
          description: r.romanticMatch,
        ),
        const SizedBox(height: 16),
